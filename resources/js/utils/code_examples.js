/**
 * Example code snippets used by the overlay. Pre-computing this map avoids
 * rebuilding large template strings on every button click.
 */
const CODE_EXAMPLES = {
	normalize: `
...
document.addEventListener('click', function(event) {
  if (event.target.matches('.py-code-button')) {
    ...
    const exampleCode = CODE_EXAMPLES[codeKey] || CODE_EXAMPLES.default;
